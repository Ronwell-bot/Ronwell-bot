...
| Area | What I Bring |
| --- | --- |
| **Testing** | Functional testing, feature checks, test-scenario thinking, and behavior verification |
| **Debugging** | Problem diagnosis, troubleshooting, issue isolation, and iterative fixes |
| **Documentation** | Project documentation, issue notes, technical explanations, and organized information |
| **User Experience** | Clear interfaces, readable feedback, responsive layouts, and practical workflows |
| **Collaboration** | Communication, coordination, organization, adaptability, and willingness to learn |
...
- **Bachelor of Science in Computer Science** — Far Eastern University – Alabang, 2022–2023
